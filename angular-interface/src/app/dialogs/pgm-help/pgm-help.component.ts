...
export class PgmHelpComponent implements OnInit {
  ...
  constructor(
    ...
    this.data.help_url = "https://loosolab.pages.gwdg.de/container/bcu-documentation/angular_interface/pgm"
    // Assuming url is the dynamic URL you want to bind
    this.sanitizedUrl = this.sanitizer.bypassSecurityTrustResourceUrl(this.data.help_url);
